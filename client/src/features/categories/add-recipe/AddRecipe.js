...
//   return (
//     <div className="add-recipe-container">
//       <div className="add-title">הוספת מתכון</div>
//       <div className="add-recipe-form-container">
//         <form onSubmit={handleSubmit} className="add-recipe-form-self">
//           <input name="name" type="text" placeholder="שם המתכון" />
//           <input name="description" type="text" placeholder="תיאור" />
//           <input name="amount" type="number" placeholder="מספר מנות" />
...
//                 <button type="button" onClick={() => setSelectedImage(null)}>שנה</button>
...
//             ) : (
//               <label className="upload-text">
//                 <input name="imgurl" type="file" onChange={handleImageChange} />
//                 בחר תמונה
//               </label>
//             )}
//           </div>
